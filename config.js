module.exports = {
  siteTitle: 'Pragma', // Site title.
  siteTitleAlt: 'Pragma App', // Alternative site title for SEO.
  siteLogo: '/icons/icon-512x512.png', // Logo used for SEO and manifest.
  siteUrl: 'https://pragmaco.app', // Domain of your website without pathPrefix.
  ...
  userDescription: '',
  copyright: 'Copyright © Pragma 2019. All Rights Reserved.', // Copyright string for the footer of the website and RSS feed.
